...
# installed.
TCL_PREFIX='C:/Users/lshre/Gen-AI/Langchain/env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Users/lshre/Gen-AI/Langchain/env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/Users/lshre/Gen-AI/Langchain/env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Users/lshre/Gen-AI/Langchain/env\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Users/lshre/Gen-AI/Langchain/env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/Users/lshre/Gen-AI/Langchain/env\Library\lib\tclstub86.lib'
